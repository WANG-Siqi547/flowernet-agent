...
async def health():
    ...
    return {
        ...
        "service": "FlowerNet Outliner",
        "status": "healthy",
        "source_version": "2026-06-24-outliner-deepseek-single-call-v2",
...
async def debug():
    ...
    return {
        ...
        "outliner": {
            ...
            "remote_single_llm_call": getattr(outliner, "remote_single_llm_call", None) if outliner else None,
        ...
        "environment": {
            ...
            "OUTLINER_REMOTE_SINGLE_LLM_CALL": os.getenv("OUTLINER_REMOTE_SINGLE_LLM_CALL", "NOT SET"),
